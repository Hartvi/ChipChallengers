...
public static class UIStrings
{
    ...
    public static readonly string[] ControlsKeys = {
        "F1", "1-9", "up/down/+/-", "Ctrl+O", "Ctrl+M", "Ctrl+U", "Ctrl+R", "Ctrl+S", "Ctrl+P", "Ctrl+C"
    };
    public static readonly string[] ControlsActions = new string[] {
        "Display this panel", "Switch cameras", "Adjust camera", "Open model", "Open map", "Go to start", "Reset model", "Save model (in editor)", "Go to playmode (from editor)", "Load scenario"
    };
